...
namespace eval ::irken {
    ...
    proc initui {} {
        ...
        bind . <Prior> [list %W yview scroll -1 page]
        bind . <Next> [list %W yview scroll 1 page]
        ...
        bind . <Control-c> {if {[set r [%W tag nextrange sel 0.0]] ne ""} {clipboard clear; clipboard append [%W get {*}$r]}}
