...
set ::friends [dict create]
set ::onlinefriends [dict create]
set ::friendconfpath "~/.config/irken/friend.conf"
set ::isonseen [dict create]
set ::friendicon {}
...
proc updatefriendconf {} {
    if {![catch {open $::friendconfpath w} fp]} {
        ...
        addchantext $::active "Warning: unable to write to $::friendconfpath\n" -tags {fg_red italic}
    }
}
...
proc updatepresence {serverid} {
    ...
    after 60000 updatepresence $serverid
}
...
hook handle001 friend 50 {serverid msg} {
    ...
    sendpendingison $serverid
    after 500 updatepresence $serverid
}
